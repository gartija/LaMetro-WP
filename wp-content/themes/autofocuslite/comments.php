...
$autofocus_comment_fields =  array(
	'comment_notes_before' => '<p class="comment-notes">' . __( 'Your email address will not be published.', 'autofocus' ) . ( $req ? '<br>Required fields are marked:<span class="required">*</span>' : '' ) . '</p>'
);
