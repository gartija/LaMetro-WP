...
<?php 
	...
	$autofocus_css_options_output = TEMPLATEPATH . '/css/style.options.php'; 
	if( is_file( $autofocus_css_options_output ) ) 
		require $autofocus_css_options_output;
...
/* <![CDATA[ */
<?php 
$autofocus_js_options_output = TEMPLATEPATH . '/js/js.options.php'; 
if( is_file( $autofocus_js_options_output ) ) 
	require $autofocus_js_options_output; 
?>
 ...
 * Footer text 
 */
function autofocus_display_footer_text() {
	global $shortname;
