...
function autofocus_commentfield() {	
	$commentArea = '<p class="comment-form-comment"><label for="comment">' . __( 'Comment', 'autofocus' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required placeholder="' . __( 'What&#8217;s on your mind?', 'autofocus') . '"></textarea></p>';
	return $commentArea;
}
...
function autofocus_post_classes($classes) {
	global $post, $autofocus_post_alt;
